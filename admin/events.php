  ...
  <div class="container-fluid">
    ...
    <nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="#" class="nav-item nav-events"><span class='icon-field'><i class="fa fa-calendar-day"></i></span> Events</a>
						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<?php 
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-danger delete_event" type="button" data-id=""><a href="delete-event.php?id=<?php echo $row["id"]; ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
